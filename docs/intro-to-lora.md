...
1. A wizard starts. Answer the questions.
    ...
    <span class="images">![Configuring the MultiTech Conduit gateway for The Things Network](assets/ttn5.png)<span>Wizard for configuring the MultiTech Conduit</span></span>.
...
1. Fill in the remaining questions.
    ...
    <span class="images">![Configuring the MultiTech Conduit gateway for The Things Network (step 2)](assets/ttn6.png)<span>Wizard (2) for configuring the MultiTech Conduit</span></span>.
...
Mbed comes with the Arm Mbed Online Compiler, which you can use to build applications without needing to install anything on your computer. (Mbed also has [offline tools](https://os.mbed.com/docs/latest/tools/index.html)).
...
<span class="images">![Application that shows movement information, built using Mbed OS and The Things Network](assets/lora19.png)<span>Demo application</span></span>
